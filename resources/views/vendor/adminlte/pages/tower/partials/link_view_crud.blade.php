...
<button type="button" class="btn btn-info btn-sm pull-right" data-toggle="modal" data-target="#addModal_tl">Add New Source Link</button>
<br>
<br>
    ...
    <table id="broadcast" class="table table-bordered table-striped">
        ...
        @foreach($tower->towerlink as $tower_link)
            <tr>
                ...
                <td>@if ($tower_link->connection_method  ==  null) unknown !   @else {{ $tower_link->connection_method }} @endif</td>
...
<input type="hidden" name="hidden_delete_tl" id="hidden_delete_tl" value="{{url('isp-cpanel/tower/tower_link/delete')}}">
            ...
            <div class="modal-body">
                <form action="{{ url('isp-cpanel/tower/tower_link') }}" method="post">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            <label for="source_name"><div class="fa fa-gears"></div> Source Name :</label>
                            <input type="text" class="form-control" id="source_name" name="source_name">
                        </div>
                        <div class="form-group">
                            <label><div class="fa fa-gears"></div> Connection Method :</label>
                            {!! Form::select("connection_method", connection_method(), null ,['class'=>'form-control','name'=>'connection_method']) !!}
                        </div>
                ...
                <div class="box-body no-padding">
                    ...
                    <table id="wirless_show" class="table table-striped">
                        ...
                        <tr class="Active">
                            <td> <label  class="glyphicon glyphicon-info-sign" style="color: green ; font-size: 21px;" href="#" class="tooltip-large" data-toggle="tooltip" data-placement="left" title="any sign for hint the broadcast"></label></td>
                            <td>Wireless type :</td>
                            <td><span id="view_connection_method"></span></td>
                        </tr>
                        <tr class="Active">
                            <td> <label  class="glyphicon glyphicon-info-sign" style="color: green ; font-size: 21px;" href="#" class="tooltip-large" data-toggle="tooltip" data-placement="left" title="any sign for hint the broadcast"></label></td>
...
<div id="show_message_lan"> <p> There is no settings for LAN connection</p></div>
                    <div id="wirless_edit">
                    <div  class="box box-warning box-solid" >
                        <div  class="box-header with-border">
                            <div  class="form-group">
                                <label for="edit_repeater_name">Repeater Name: </label>
                                <input type="text" class="form-control" id="edit_repeater_name" name="repeater_name">
                            </div>
                            <div class="form-group">
                                <label for="edit_wireless_type"> <div class="fa fa-gears"></div> Wireless Type:</label>
                            ...
                            <div class="form-group">
                                <label for="edit_channal_width"> <div class="fa fa-gears"></div> Authentication Type :</label>
                   ...
                   <div id="fiber_edit">
                       ...
                       <div class="form-group">
                           <label for="edit_fiber_core">Fiber Core : </label>
                           <input type="text" class="form-control" id="edit_fiber_core" name="fiber_core">
                       </div>
                       <div class="form-group">
                           <label for="edit_fiber_sfp_type">Fiber SFP Type : </label>
                           <input type="text" class="form-control" id="edit_fiber_sfp_type" name="fiber_sfp_type">
                       </div>
                       <div class="form-group">
                           <label for="edit_fiber_distance">Fiber Distance : </label>
                           <input type="text" class="form-control" id="edit_fiber_distance" name="fiber_distance">
                       </div>
                       <div class="form-group">
                           <label for="edit_fiber_master_port_number">Fiber Master Port Number : </label>
                           <input type="text" class="form-control" id="edit_fiber_master_port_number" name="fiber_master_port_number">
                       </div>
                       <div class="form-group">
                           <label for="edit_fiber_clint_port_number">Fiber Clint Port Number : </label>
                           <input type="text" class="form-control" id="edit_fiber_clint_port_number" name="fiber_clint_port_number">
                       </div>
                   </div>
                   </div>
                   </div>
