...
<div class="col-md-4 col-12-4 col-xs-4">
    <div class="info-box">
        ...
        <div class="info-box-content" style="padding-top:5px;">
            ...
            <small class="info-box-number"><small style="color: red;">{{ App\CustomerTicket::where('status','1')->whereColumn('created_at', '>=', Carbon\Carbon::today())->count() }}</small> &nbsp; Open By members Today</small>
            <small class="info-box-number"><small style="color: green;">{{ App\CustomerTicket::where('status','0')->whereColumn('created_at', '>=', Carbon\Carbon::today())->count() }}</small> &nbsp; Closed By members Today</small>
        </div>
    </div>
</div>
<!-----  ==============  ------>
...
<div class="col-md-4 col-12-4 col-xs-4">
        <div class="info-box">
            ...
            <div class="info-box-content" style="padding-top:5px;">
                ...
                <small class="info-box-number" style="margin-top: 10px;">{{ App\RefillCustomer::with('user')->where('created_by', Auth::user()->id)->whereColumn('created_at', '>=', Carbon\Carbon::today())->count() }} &nbsp; Card Refill Today</small>
                <small class="info-box-number"><small style="color: red;">{{ App\RefillCustomer::with('user')->where('created_by', Auth::user()->id)->where('payment_status','1')->whereColumn('created_at', '>=', Carbon\Carbon::today())->count() }}</small> &nbsp; Unpaid Refill</small>
            </div>
        </div>
    </div>
