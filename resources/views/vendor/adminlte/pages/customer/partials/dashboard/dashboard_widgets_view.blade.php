    ...
    <div class="col-md-4 col-12-4 col-xs-4">
        <div class="info-box">
            ...
            <div class="info-box-content" style="padding-top:5px;">
                ...
                <small class="info-box-number">{{ App\CustomerTicket::with('user')->where('created_by', Auth::user()->id)->where('status','1')->where('created_at', '>=', Carbon\Carbon::today())->count() }} &nbsp; Open Today</small>
                <small class="info-box-number">{{ App\CustomerTicket::with('user')->where('created_by', Auth::user()->id)->where('status','0')->where('created_at', '>=', Carbon\Carbon::today())->count() }} &nbsp; Closed Owned Today</small>
