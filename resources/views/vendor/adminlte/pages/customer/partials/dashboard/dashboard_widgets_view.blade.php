    ...
    <div class="col-md-4 col-12-4 col-xs-4">
        <div class="info-box">
            ...
            <div class="info-box-content" style="padding-top:5px;">
                ...
                <small class="info-box-number"><small style="color: green;">{{ number_format(App\RefillCustomer::with('user')->where('created_by', Auth::user()->id)->whereColumn('created_at', '>=', Carbon\Carbon::today())->pluck('second_paid')->sum()) }}</small> &nbsp; Total Repayment</small>
            </div>
        </div>
    </div>
