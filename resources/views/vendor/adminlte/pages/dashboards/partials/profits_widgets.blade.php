...
<div class="col-md-4 col-12-4 col-xs-4">
    <div class="info-box">
        <span class="info-box-icon bg-blue" ><i class="fa fa-money" style="padding-top:20px;"></i></span>
        <div class="info-box-content" style="padding-top:5px;">
            ...
            <small class="info-box-number" style="margin-top: 10px;">{{ number_format(App\RefillCustomer::where('created_at', '>=', Carbon\Carbon::today())->pluck('card_price')->sum() - App\RefillCustomer::where('created_at', '>=', Carbon\Carbon::today())->pluck('card_cost')->sum()) }} &nbsp; Today Total Profits </small>
...
<div class="col-md-4 col-12-4 col-xs-4">
    <div class="info-box">
        <span class="info-box-icon bg-blue"><i class="fa fa-line-chart" style="padding-top:20px;"></i></span>
        <div class="info-box-content" style="padding-top:5px;">
