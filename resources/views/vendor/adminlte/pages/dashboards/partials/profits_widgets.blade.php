<div class="col-md-4 col-12-4 col-xs-4">
    <div class="info-box">
        <span class="info-box-icon bg-blue-gradient" ><i class="fa fa-money" style="padding-top:20px;"></i></span>
...
<div class="col-md-4 col-12-4 col-xs-4">
    <div class="info-box">
        <span class="info-box-icon bg-blue-gradient"><i class="fa fa-line-chart" style="padding-top:20px;"></i></span>
        <div class="info-box-content" style="padding-top:5px;">
            <small class="info-box-text">This <strong class="text-green">Month</strong> Card Refill</small>
