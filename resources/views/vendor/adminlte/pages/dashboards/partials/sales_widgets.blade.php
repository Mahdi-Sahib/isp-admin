...
<div class="col-md-4 col-12-4 col-xs-4">
    <div class="info-box">
        ...
        <div class="info-box-content" style="padding-top:5px;">
            ...
            <small class="info-box-number"><small style="color: green;">{{ number_format(App\RefillCustomer::where('created_at', '>=', Carbon\Carbon::yesterday())->pluck('second_paid')->sum()) }}</small> &nbsp; Total Repayment</small>
        </div>
    </div>
</div>
...
<div class="col-md-4 col-12-4 col-xs-4">
    <div class="info-box">
        ...
        <div class="info-box-content" style="padding-top:5px;">
            ...
            <small class="info-box-number"><small style="color: blue;">{{ number_format(App\RefillCustomer::where('created_at', '>=', Carbon\Carbon::yesterday())->pluck('amount_paid')->sum()) }}</small> Total Income</small>
        </div>
    </div>
</div>
